...
//В  комментариях объясните разницу результатов задания 2 и задания 3, если она есть.
//Измените код задания 3. 
//Вывод “H” не меняется. то есть буква выводится на глобальной очереди, а перед этим вызывается sleep(1). Остальные же буквы выводить просто через print, то есть
//print("E")
//print("L")
//print("L")
//print("O")
